    ...
    <div class="col-8">
        <div class="card">
            <div class="card-header">
                ...
                <h3 class="card-title">Edit Data Barang Keluar</h3>
            </div>
                        ...
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="col-md-8 mb-2">
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="number" name="jumlah" class="form-control" placeholder="Jumlah Masuk" id="jumlah" value="{{ $idBarang->jumlah_keluar }}" required>
                                            <div class="form-control-icon">
                                                <i class="bi bi-123"></i>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-8 mb-2">
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="date" name="waktu" value="{{ $idBarang->waktu_keluar }}" class="form-control" placeholder="Waktu Masuk" id="waktu" required>
                                            <div class="form-control-icon">
