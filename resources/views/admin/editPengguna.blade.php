            ...
            <div class="card-content">
                <div class="card-body">
                    <form class="form form-horizontal" method="POST"
                        action="{{ url('/admin/daftar-pengguna/' . $user->id) }}">
                        @method('put')
                        @csrf
                        <div class="form-body">
                            <div class="row">
                                    ...
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="text" name="nama" class="form-control"
                                                placeholder="Nama Pengguna" id="nama" value="{{ $user->name }}"
                                                required>
                                    ...
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="text" name="username" class="form-control"
                                                placeholder="Username Pengguna" id="username"
                                    ...
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="password" name="password" class="form-control"
                                                placeholder="************" id="satuan" value="{{ $user->password }}"
                                                required>
                                            <div class="form-control-icon">
                                                <i class="bi bi-key"></i>
                                            </div>
                                    ...
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="number" name="no_telp" class="form-control"
                                                placeholder="082189898989" id="no_telp" value="{{ $user->no_telp }}"
                                                required>
                                            <div class="form-control-icon">
