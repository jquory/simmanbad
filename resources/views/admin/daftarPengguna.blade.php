...
<section class="section">
    <div class="card">
        ...
        <div class="card-header d-flex justify-content-between">
            ...
            <a href="{{ url('/admin/daftar-pengguna/create') }}" class="btn btn-primary">Tambah Pengguna</a>
        </div>
        <div class="card-body">
            <table class="table" id="table1">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="{{ $record->role === 'admin' ? 'text-primary' : 'text-secondary' }}">{{ $record->role
                            }}</td>
                        <td>{{ \Carbon\Carbon::parse($record->created_at)->isoFormat('dddd, D MMMM Y hh:mm') }}</td>
                        <td style="display: flex; gap:5px;">
                            <a type="button" href="{{ url('/admin/daftar-pengguna/' . $record->uuid . '/edit') }}"
                                class="btn btn-outline-success" data-bs-toggle="tooltip" data-bs-title="Edit">
                                <i class="bi bi-pen-fill"></i>
                            </a>
                            <button class="btn btn-danger" data-bs-toggle="modal"
                                data-bs-target="#deleteModal{{ $record->id }}" data-bs-toggle="tooltip"
                                data-bs-title="Hapus">
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <form action="{{ url('/admin/daftar-pengguna/' . $record->id) }}" method="post">
                                        @csrf
                                        @method('DELETE')
