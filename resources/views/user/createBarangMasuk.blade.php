    ...
    <div class="col-8">
        <div class="card">
            <div class="card-header">
                <a href="{{ url('/user/barang-masuk') }}" class="d-flex gap-2 mb-3">
            ...
            <div class="card-content">
                <div class="card-body">
                    <form class="form form-horizontal" method="POST" action="{{ url('/user/barang-masuk/store') }}">
                        @method('post')
                        @csrf
                        <div class="form-body">
                            <div class="row">
                                    ...
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="number" name="jumlah" class="form-control"
                                                placeholder="Jumlah Masuk" id="jumlah" required>
                                            <div class="form-control-icon">
                                                <i class="bi bi-123"></i>
                                            </div>
                                        </div>
...
<script type="text/javascript">
    function autoFill() {
        ...
        if(id !== "") {
            const url = '/user/barang-masuk/getDetail/' + id
            fetch(url)
            .then(res => res.json())
            .then(data => {
